...
export function SupervisorServiceDetails({ remarks, items, className = "" }) {
  ...
  return (
    <div
      className={`space-y-1.5 text-sm rounded-md border border-border p-2.5 no-print ${className}`}
    >
      <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
        Service Details — added by Supervisor
      </p>
      {hasRemarks && (
        <div>
