...
import { ClipboardList, Eye, EyeOff, Receipt, ShieldCheck, UserCog, Wrench } from "lucide-react";
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 flex items-start gap-2 rounded-md border border-border bg-muted/40 px-3 py-2.5">
            ...
            <p className="text-xs text-muted-foreground">
              Restricted to authorized DriveWell staff. Accounts are created by a manager — contact
              yours if you can't sign in.
            </p>
          </div>
        </div>
      </div>
