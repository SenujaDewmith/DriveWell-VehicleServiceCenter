...
function validate(form) {
  ...
  if (form.default_price === "" || form.default_price === undefined)
    errors.default_price = "Default price is required";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Reference price list for additional repairs/parts — used by cashiers when itemizing
            invoices
          </p>
        </div>
        <button
        ...
        <div className="rounded-lg border border-border bg-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-semibold text-foreground">
              {editing ? "Edit Charge" : "New Charge"}
            </h3>
            ...
            <div className="space-y-1">
              ...
              {formErrors.default_price ? (
                ...
                <p className="text-sm text-muted-foreground">
                  Suggested price — cashier can still adjust per invoice
                </p>
              )}
            </div>
            ...
            <tbody>
              {items.map((item) => (
                ...
                >
                  ...
                  <td className="py-3 px-3">
                    <span
                      className={`text-sm font-medium ${item.is_active ? "text-accent" : "text-muted-foreground"}`}
                    >
