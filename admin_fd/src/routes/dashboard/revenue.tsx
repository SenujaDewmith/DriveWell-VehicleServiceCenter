          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="rounded-lg border border-border bg-card p-4">
              ...
              <p className="text-lg font-bold text-foreground mt-1">
                LKR {paidRevenue.toLocaleString()} <span className="text-muted-foreground text-sm">/</span> LKR {unpaidRevenue.toLocaleString()}
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-4">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-left py-3 px-3 font-medium text-muted-foreground">Invoices</th>
                      <th className="text-left py-3 px-3 font-medium text-muted-foreground">Revenue (LKR)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {byPackage.map((p) => (
