...
export function PlateNumberInput({ id, value, onChange, onBlur, error, disabled }: PlateNumberInputProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      <Input
        ...
        className={cn("w-20 text-center uppercase tracking-widest", errorClass)}
      />
      ...
      <Input
        ...
        className={cn("w-24 text-center tracking-widest", errorClass)}
      />
    </div>
  );
}
