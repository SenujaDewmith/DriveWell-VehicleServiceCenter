...
interface LogoProps {
  ...
  variant?: "full" | "icon";
  /**
   * Which artwork to show. Defaults to "auto", which follows the app theme
   * (`.dark` class) via CSS. Pass "light" or "dark" to pin the artwork on a
   * surface with a fixed background regardless of theme (e.g. a footer that
   * is always dark).
   */
...
export function Logo({ variant = "full", theme = "auto", className, alt = "DriveWell" }: LogoProps) {
