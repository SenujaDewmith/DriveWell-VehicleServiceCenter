...
export function RegisterForm({ onSuccess, onSwitchToLogin }) {
    ...
    return (<div>
      ...
      {onSwitchToLogin && (<p className="mt-6 text-center text-sm text-muted-foreground">
          Already have an account?{" "}
          <button type="button" onClick={onSwitchToLogin} className="text-cta hover:underline font-medium">
            Sign in
          </button>
        </p>)}
    </div>);
