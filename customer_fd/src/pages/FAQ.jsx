        ...
        items: [
            {
                ...
                answer: "Go to Services, choose a package, then pick a date and time slot — availability shown at booking time reflects real remaining capacity, so the slot you pick is guaranteed.",
            },
            {
            ...
            },
            {
                ...
                answer: "If you don't show up for a confirmed slot, it's marked as a no-show in your booking history. If your plans change, cancelling ahead of time frees up the slot for another customer.",
            },
            {
        ...
        items: [
            {
                ...
                answer: "Yes. Add each vehicle under My Vehicles, and you'll be able to choose which one you're booking a service for at checkout.",
            },
            {
                question: "How do I know when my next service is due?",
                answer: "For any service that includes an oil change, your booking detail page shows the next due point — a target odometer reading or a fixed number of months from the service date, whichever comes first — so you're not guessing.",
            },
            {
                question: "Will I be told before extra work is added to my bill?",
                answer: "Yes. Any work beyond the booked package is itemized separately on your invoice, so you can see exactly what was added and why before you pay.",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                answer: "Payment is collected at the service center when you pick up your vehicle. Once settled, a digital invoice is generated and available under Invoices in your account.",
            },
            {
                question: "Are the invoices itemized?",
                answer: "Every invoice breaks down the base package price, any additional charges, and discounts applied, with a final total — so there are no surprise line items.",
            },
        ],
    },
    {
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            {categories.map((category) => (<div key={category.title}>
                ...
                <Accordion type="single" collapsible className="w-full">
                  {category.items.map((item, index) => (<AccordionItem key={item.question} value={`${category.title}-${index}`}>
      ...
      <section className="py-20 bg-gradient-to-r from-secondary to-accent text-secondary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-cta text-cta-foreground hover:bg-cta/90 text-lg px-8 py-6" onClick={() => navigate("/services")}>
              View Our Services
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-secondary-foreground/30 hover:bg-secondary-foreground/10" onClick={() => navigate("/about")}>
              About DriveWell
            </Button>
          </div>
        </div>
