...
export async function getCroppedImageBlob(imageSrc, cropAreaPixels, outputSize = 512) {
    ...
    ctx.drawImage(image, cropAreaPixels.x, cropAreaPixels.y, cropAreaPixels.width, cropAreaPixels.height, 0, 0, outputSize, outputSize);
    return new Promise((resolve, reject) => {
